        ...
        <div className="block md:flex md:items-center">
          ...
          <div className="block md:w-1/2 md:px-3 lg:px-6 max-w-md w-full px-2 mx-auto">
            <h3 className="text-sm md:text-base">
              Souscrivez à <span className="font-semibold text-indigo-700">CalebChat</span>
            </h3>
            <p className="mt-3 text-xs mb-3 md:text-sm">
              Beneficiez de l'actualité de notre plateforme ainsi que des nouveautés et mise à jour de cours et formations
            </p>
